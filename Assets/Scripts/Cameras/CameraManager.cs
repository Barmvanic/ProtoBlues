...
public class CameraManager : MonoBehaviour
{
    ...
    [SerializeField] private CinemachineVirtualCamera[] _allVirtualCameras; // array for all the cameras 

    [Header("Controls for lerping the Y Damping during plauer jump/fall ")]
    [SerializeField] private float _fallPanAmount = 0.25f;
    [SerializeField] private float _fallYPanTime = 0.5f;
    public float _fallSpeddYDamplingChangeTreshold = -15f;
    ...
    private void Awake()
    {
        ...
        // set the YDamping amount so it's based on the inspector 
